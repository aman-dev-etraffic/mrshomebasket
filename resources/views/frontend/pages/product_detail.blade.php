									...
									@if($product_detail->size)
										<div class="size mt-4">
											...
											<ul class="select-option">
												...
												<li class="variant_option"><a href="#" class="one @if($loop->first)selected @endif" value="{{$size}}">{{$size}}</a></li>
												@endforeach
											</ul>
										</div>
									@endif
										...
										<form action="{{route('single-add-to-cart')}}" method="POST">
											...
											<div class="quantity">
												...
												<div class="input-group">
    												...
    												@endphp
    												@endif
													<input type="hidden" name="size" class="hidden_size_val" value="{{ $sizes[0] ?? '' }}">
...
<script>
    $('.variant_option a').on('click',function(e){
        e.preventDefault();
        $('.variant_option a.selected').removeClass('selected');
        $(this).addClass('selected');
        var size_val = $(this).attr('value');
        $('.hidden_size_val').attr('value',size_val);
    });
</script>
    {{-- <script>
        $('.cart').click(function(){
